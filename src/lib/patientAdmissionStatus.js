...
// which sets this instead of just clearing pendingTransfer). The patient
// reappears on the sending ward's own list — never left it, ward-wise —
// so this is a "welcome back" tag rather than an arrival, but the same
